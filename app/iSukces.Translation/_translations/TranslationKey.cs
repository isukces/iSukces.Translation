...
public sealed class TranslationKey : IEquatable<TranslationKey>, IComparable<TranslationKey>, IComparable
{
    ...
    public static bool operator ==(TranslationKey? left, TranslationKey? right) => Equals(left, right);
    ...
    public override bool Equals(object? obj) => ReferenceEquals(this, obj) || obj is TranslationKey other && Equals(other);
